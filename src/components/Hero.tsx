      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex justify-center mb-8 animate-fade-in">
            <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full text-sm font-medium shadow-elegant">
              <Sparkles className="w-4 h-4 text-accent" />
              <span>Studio d'automatisation nouvelle génération</span>
            </div>
          </div>
